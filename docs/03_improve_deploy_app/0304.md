...
13. Configure your `dev` environment to pull the latest container image from ACR.
   13.1 - Log into Azure using your service principal, if needed ([hint](https://docs.microsoft.com/azure/app-service/deploy-container-github-action?tabs=service-principal#tabpanel_CeZOj-G++Q-3_service-principal)).
