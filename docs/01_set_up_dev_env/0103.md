...
2. Navigate to the Compute Gallery you created and open Access Control (IAM). Add the managed identity using the ID or the name of your dev center and grant the managed identity the Managed Application Contributor Role.
