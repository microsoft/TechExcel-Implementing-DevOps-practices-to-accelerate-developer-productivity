...
<details>
<summary><b>Stretch goal solution:</b> Expand this section to view the solution to create your own custom image.</summary>
...
6. RDP Into the box and download/install the following software:
...
7. Reboot after installing all of the software and ensure that Docker is running before performing a sysprep.
